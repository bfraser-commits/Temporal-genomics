...
library(cowplot)
#SLIMS
real <- read.table("Documents/FIBR_temporal/cvtk/real_data/gw_covs_mean_unphased_no15.tsv", header=T,  sep ="\t")
...
pdf("Documents/FIBR_temporal/cvtk/across_time_cov_violin_colour_no15.pdf", width=6, height=4)
all_time_plot
dev.off()
...
pdf("Documents/FIBR_temporal/cvtk/time_interval_1_violin_colour_no15.pdf", width=8, height=4)
all_13_plot
dev.off()
...
pdf("Documents/FIBR_temporal/cvtk/time_interval_2_violin_colour_no15.pdf", width=8, height=4)
all_18_plot
dev.off()
